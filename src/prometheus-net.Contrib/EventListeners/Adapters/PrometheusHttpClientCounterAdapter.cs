...
namespace Prometheus.Contrib.EventListeners.Adapters
{
    internal class PrometheusHttpClientCounterAdapter : BaseAdapter
    {
        ...
        internal readonly MeanCounter Http11RequestsQueueDuration = new MeanCounter("http11-requests-queue-duration", "http_client_http11_requests_queue_duration_milliseconds", "HTTP 1.1 Requests Queue Duration");
        internal readonly MeanCounter Http20RequestsQueueDuration = new MeanCounter("http20-requests-queue-duration", "http_client_http20_requests_queue_duration_milliseconds", "HTTP 2.0 Requests Queue Duration");
    }
}
